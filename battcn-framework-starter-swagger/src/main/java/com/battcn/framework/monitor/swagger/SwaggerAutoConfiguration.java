...
public class SwaggerAutoConfiguration {
    ...
    public Docket petApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //.globalOperationParameters(newArrayList(new ParameterBuilder().name("someGlobalParameter").description("Description of someGlobalParameter").modelRef(new ModelRef("string")).parameterType("query").required(true).build()))
    ...
    private ApiInfo apiInfo() {
    	...
    	com.battcn.framework.monitor.swagger.properties.Contact contact = apiInfo.getContact();
